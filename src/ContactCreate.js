                ...
                <div className="col-lg-12">
                  <div className="card">
                    <div className="card-body">
                      ...
                      { formData && formData['Text'] &&  <Form values={location.state &&  location.state!== typeof undefined?location.state:{}} goTo='/Contact' object='Contactos' referencesObject={referenceObjectsData} formData={formData} />}
                    </div>
                  </div>
                </div>
              </div>
