  ...
  const getFieldsForObject = async()=>{
    ...
    if(window.localStorage.getItem('BranchFormData')){
      ...
      { headers: { 
          ...
          window.localStorage.setItem("BranchFormData", JSON.stringify(formData));
          console.log(formData);
          dataRetrieved = true;
          console.log(formData)
          setLoading(false);
                ...
                <div className="col-lg-12">
                  <div className="card">
                    <div className="card-body">
                      ...
                      { formData  &&  <Form values={location.state &&  location.state!== typeof undefined?location.state._fieldsProto:{}} formData={formData} />}
                    </div>
                  </div>
                </div>
              </div>
